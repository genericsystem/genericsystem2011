...
public class SizeTest extends AbstractTest {
	...
	public void mountSize() {
		...
		assert sizeConstraint.getAttribute( SizeConstraintImpl.SIZE) != null : sizeConstraint.info() + " " + sizeConstraint.getAttributes();
	}
	...
	public void checkConstraintWithAttribute() {
		...
		vehiclePower.newInstance( 123, myVehicle1);
		new RollbackCatcher() {

			@Override
			public void intercept() {
				vehiclePower.newInstance( 126, myVehicle1);
			}
