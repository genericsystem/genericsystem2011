...
public class TypeAdministrationComponent extends AbstractGenericCollectableChildrenComponent implements ValuedComponent, Serializable {

	private static final long serialVersionUID = 8535589374953183508L;

	private String newValue;

	public TypeAdministrationComponent(AbstractComponent parent, Generic selected) {
